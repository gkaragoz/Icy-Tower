...
namespace GoogleMobileAds.Editor
{
    ...
    {
        private const string MobileAdsSettingsDir = "Assets/SDKs/GoogleMobileAds";

        private const string MobileAdsSettingsResDir = "Assets/SDKs/GoogleMobileAds/Resources";

        private const string MobileAdsSettingsFile =
            "Assets/SDKs/GoogleMobileAds/Resources/GoogleMobileAdsSettings.asset";
